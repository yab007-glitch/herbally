import {
  ...
  kgToLbs,
  recommendFormula,
} from "./src/lib/utils/dosage-calculations";
...
self.addEventListener("message", (event) => {
  if (event.data.type === "CALCULATE_DOSAGE") {
    ...
    switch (formula) {
      case "clarks_rule":
        result = dosageCalculator.clarksRule(
          params.weightKg,
          params.adultDoseMg
        );
        break;
      case "youngs_rule":
        result = dosageCalculator.youngsRule(
          params.ageYears,
          params.adultDoseMg
        );
        break;
      case "bsa":
        result = dosageCalculator.bsaMethod(
          params.heightCm,
          params.weightKg,
          params.adultDoseMg
        );
        break;
      case "fried_rule":
        result = dosageCalculator.friedsRule(
          params.ageMonths,
          params.adultDoseMg
        );
        break;
