...
async function getHerbsToProcess(): Promise<Herb[]> {
  ...
  console.log(`   Found ${autoGenSlugs.size} auto-generated monographs to upgrade\n`);
  ...
  console.log(`   After filtering progress/hand-written: ${targetSlugs.length} herbs to process\n`);
